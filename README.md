...
১. ক্যাটাগরি সিলেক্ট করুন (Note, Link, বা Key)। ২. একটি টাইটেল (Title) দিন এবং মূল লেখাটি টাইপ করুন। ৩. Add বাটনে ক্লিক করে বড় আতশবাজি উপভোগ করুন এবং তথ্যটি সেভ করুন। ৪. আপনার সেভ করা সব তথ্য নিচেই সুন্দরভাবে সাজানো থাকবে যা আপনি যেকোনো সময় কপি বা ডিলিট করতে পারবেন।
